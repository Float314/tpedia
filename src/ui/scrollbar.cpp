/* 
    ...
    Copyright (C) 2021, Arthur Sonzogni.
    Derived from git-tui 

    Please add this compo into main ftxui pls sonzogni i beg you. 

    Anyways, licensed under the MIT (this script).
*/
